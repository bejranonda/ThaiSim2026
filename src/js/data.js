...
export const phases = [
    {
        ...
        options: [
            { id: "p1-1", label: "ดิจิทัลวอลเล็ต / รัฐร่วมจ่าย", desc: "กระตุ้นเศรษฐกิจครั้งใหญ่ด้วยเงินดิจิทัล", stats: { eco: 20, soc: 5, lib: 5, budget: -26 }, party: ["PTP", "ECO", "CP"] },
    ...
    },
    {
        ...
        options: [
            ...
            { id: "p2-5", label: "เกษตรสีเขียว / น้ำบาดาล", desc: "ขายคาร์บอนเครดิตและจัดหาแหล่งน้ำทั่วถึง", stats: { eco: 10, soc: 10, lib: 5, budget: 6 }, party: ["CTP", "ECO"] },
    ...
    },
    {
        ...
        options: [
            ...
            { id: "p3-6", label: "เงินอุดหนุนเด็ก/คนท้อง", desc: "ดูแลแม่และเด็กแรกเกิดอย่างเข้มข้น", stats: { eco: 5, soc: 20, lib: 5, budget: -15 }, party: ["TKM", "DEM", "PPRP"] },
    ...
    },
    {
        ...
        icon: "fa-gavel",
        options: [
            { id: "p4-1", label: "ประหารชีวิตคนโกง", desc: "ลงโทษสูงสุดกับข้าราชการ/นักการเมืองที่ทุจริต", stats: { eco: 0, soc: 10, lib: -10, budget: 6 }, party: ["UTN", "ECO", "SRT"] },
    ...
    },
    {
        ...
        options: [
            ...
            { id: "p5-6", label: "ปราบยาเสพติดเด็ดขาด", desc: "กวาดล้างผู้ค้า และบำบัดผู้เสพ", stats: { eco: 0, soc: 20, lib: -5, budget: -13 }, party: ["PTP", "KLA"] },
    ...
    },
    {
        ...
        options: [
            ...
            { id: "p6-5", label: "ทักษะอนาคต (Wellness/Tech)", desc: "สร้างทักษะแรงงานมูลค่าสูง", stats: { eco: 15, soc: 5, lib: 5, budget: -9 }, party: ["PTP"] },
